########## Below extracted from https://github.com/hashicorp/docker-consul/blob/master/0.X/docker-entrypoint.sh  #########
...
exec "$@"
########## Above extracted from https://github.com/hashicorp/docker-consul/blob/master/0.X/docker-entrypoint.sh  #########

# below is for running node-exporter
